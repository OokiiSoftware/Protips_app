...
class MyWidgetState extends State<NewPostPage> {
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Column(children: [
              //Titulo
              CustomTextField(_titulo, TextInputType.name, MyStrings.TITULO, valueIsEmpty: _tituloIsEmpty, onTap: () {setState(() {_tituloIsEmpty = false;});}),
              //Anexo
              CustomTextField(_anexo, TextInputType.name, MyStrings.ANEXAR_IMAGEM, valueIsEmpty: _anexoIsEmpty, onTap: () async {
              ...
              Row(children: [
                //Minima
                Expanded(child: CustomTextField(_oddMinima, TextInputType.number, MyStrings.ODD_MINIMA)),
                rowSpacing,
                //Maxima
                Expanded(child: CustomTextField(_oddMaxima, TextInputType.number, MyStrings.ODD_MAXIMA)),
              ]),
              //Unidades
              Row(children: [
                //Odd Atual
                Expanded(child: CustomTextField(_oddAtual, TextInputType.number, MyStrings.ODD_ATUAL, valueIsEmpty: _oddAtualIsEmpty, onTap: () {setState(() {_oddAtualIsEmpty = false;});})),
                rowSpacing,
                //Unidades
                Expanded(child: CustomTextField(_unidades, TextInputType.number, MyStrings.UNIDADES, valueIsEmpty: _unidadesIsEmpty, onTap: () {setState(() {_unidadesIsEmpty = false;});})),
              ]),
              //Horarios
              Row(children: [
                //Minimo
                Expanded(child: CustomTextField(_horarioMinimo, TextInputType.number, MyStrings.HORARIO_MINIMO, readOnly: true, onTap: () async {
                ...
                rowSpacing,
                //Maximo
                Expanded(child: CustomTextField(_horarioMaximo, TextInputType.number, MyStrings.HORARIO_MAXIMO, readOnly: true, onTap: () async {
              ...
              //Esporte / Linha
              Row(children: [
                Expanded(child: CustomTextField(_esporte, TextInputType.name, MyStrings.ESPORTE, valueIsEmpty: _esporteIsEmpty, onTap: () {setState(() {_esporteIsEmpty = false;});})),
                rowSpacing,
                Expanded(child: CustomTextField(_linha, TextInputType.name, MyStrings.LINHA)),
              ]),
              //Link
              CustomTextField(_link, TextInputType.url, MyStrings.LINK, valueIsEmpty: _linkIsEmpty, onTap: () {setState(() {_linkIsEmpty = false;});}),
              //Campeonato / Tip Publico
              Row(children: [
                Expanded(child: CustomTextField(_campeonato, TextInputType.name, MyStrings.CAMPEONATO)),
                rowSpacing,
  ...
  Widget CustomTextField(TextEditingController _controller, TextInputType _inputType, String labelText, {bool valueIsEmpty = false, bool readOnly = false, void onTap()}) {
    //region Variaveis
    double itemPaddingValue = 10;
    double itemHeight = 60;

    //region Container que contem os textField
    var itemPadding = EdgeInsets.only(left: itemPaddingValue, right: itemPaddingValue, top: 0);
